...
from lebiencollectif.presentation.models import Langue
...
class Membre(models.Model):
    ...
    Categorie = models.ManyToManyField('configuration.Categorie_Membre',related_name='Membre_Categorie_configuration_Categorie_Membre',null=True,blank=True)
