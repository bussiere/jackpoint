...
class CaracForm(forms.Form):
    ...
    carac_level = ChoiceField(label='Niveau : ',widget=RadioSelect, choices=CARAC_CHOICES)
    carac_private = ChoiceField(label='Visibility : ',widget=RadioSelect, choices=PRIVATE_CHOICES)