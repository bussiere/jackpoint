...
class SkillForm(forms.Form):
    ...
    skill_level = ChoiceField(label='Niveau : ',widget=RadioSelect, choices=CARAC_CHOICES)
    skill_private = ChoiceField(label='Visibility : ',widget=RadioSelect, choices=PRIVATE_CHOICES)